...
setuptools.setup(
    ...
    description="Dutch Rubin Enhanced Atmospheric Monitor Common Interface Library",
    use_scm_version={
        "write_to": "python/lsst/ts/dream/common/version.py",
    ...
    project_urls={
        ...
        "Source Code": "https://github.com/lsst-ts/ts_dream_common",
    },
)
